...
static Key keys[] = 
{
	...
	{ MODKEY,			XK_minus,  spawn,	   SHCMD("~/.local/bin/volume-") },
	{ MODKEY,			XK_equal,  spawn,	   SHCMD("~/.local/bin/volume+") },
	{ MODKEY|ShiftMask,		XK_equal,  setgaps,	   {.i =  0 } },
	{ MODKEY,                       XK_F5,     xrdb,           {.v = NULL } },
	{ ControlMask|ShiftMask,        XK_h,      spawn,          SHCMD("~/.local/bin/Scripts/hdmi_exit_tag") },
